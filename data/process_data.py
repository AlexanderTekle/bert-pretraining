...
if __name__ == '__main__':
    ...
    if op == "general":
        ...
        data_list = raw2list("../data/tweets-train.pkl", dataset="twitter")
        pickle.dump(data_list, open("twitter_train2.pkl", 'wb'))

        data_list = raw2list("../data/tweets-test.pkl", dataset="twitter")
        pickle.dump(data_list, open("twitter_test2.pkl", 'wb'))
